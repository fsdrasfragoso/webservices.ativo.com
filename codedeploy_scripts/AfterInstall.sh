...
[ -d /var/www/ativos/webservices.ativo.com_old/config ] && cp -prf /var/www/ativos/webservices.ativo.com_old/config /var/www/ativos/webservices.ativo.com/ || echo "Diretorio nao existe"
