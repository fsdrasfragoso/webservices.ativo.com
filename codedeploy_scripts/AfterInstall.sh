...
[ -f /var/www/ativos/webservices.ativo.com_old/wp-config.php ] && cp -pf /var/www/ativos/webservices.ativo.com_old/wp-config.php /var/www/ativos/webservices.ativo.com/ || echo "Arquivo nao existe"
