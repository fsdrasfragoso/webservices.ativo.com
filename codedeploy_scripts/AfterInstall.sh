...
[ -d /var/www/ativos/webservices.ativo.com_old/config/snappy.php ] && cp -prf /var/www/ativos/webservices.ativo.com_old/config/snappy.php /var/www/ativos/webservices.ativo.com/config/ || echo "Diretorio nao existe"
[ -d /var/www/ativos/webservices.ativo.com_old/.env] && cp -prf /var/www/ativos/webservices.ativo.com_old/.env /var/www/ativos/webservices.ativo.com/ || echo "Arquivo não existe"
